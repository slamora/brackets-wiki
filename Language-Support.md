Originally, most support for programming languages was implemented in core Brackets. Starting with [Sprint 21](https://github.com/adobe/brackets/pull/2844), the [language manager](https://github.com/adobe/brackets/blob/master/src/language/LanguageManager.js) is used for adding basic language support, like syntax highlighting and comment toggling (for a list of supported languages, see [languages.json](https://github.com/adobe/brackets/blob/master/src/language/languages.json)). The language manager can also be used by extensions. Consequently, support for non-web programming languages will be moved moved to dedicated extensions (see [issue #2969](https://github.com/adobe/brackets/issues/2969)).

Our goal is to also base features like code hinting, text manipulation commands, quick edit, live preview, etc. on these capabilities. This page documents how language support in Brackets is currently implemented. The companion page [Language Support Changes](Language Support Changes) documents what additional capabilities extensions would need in order to add language support on par with the current level of support for HTML, JavaScript and CSS. 
