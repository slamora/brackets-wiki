...
* [JSONLint](https://github.com/katsh/brackets-jsonlint) JSONLint your documents. _(Hasn't been updated in awhile; the newer [JSONLint](https://github.com/ingorichter/https://github.com/ingorichter/de.richter.brackets.jsonlint) extension uses the CodeInspection API for better UI integration.)_
