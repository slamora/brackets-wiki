...
* [Various Improvements] (https://github.com/Dammmien/brackets-various-improvements): Ddd some small improvements ( close all folders in file tree, case converter, additional information in status bar, super clipboard)
