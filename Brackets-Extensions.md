...
* [Spell Checker] (https://github.com/couzteau/SpellCheck): based on the spell checker web service <i>After The Deadline</i> - now in beta - Checks current text selection, click on error marker to see suggestions. Supports English, German, French, Spanish and Portuguese 
