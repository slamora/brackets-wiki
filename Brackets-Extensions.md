...
* [brackets-git](https://github.com/zaggino/brackets-git): Right now just an experimental code that will get your git version and displays it in status bar, but hoping to put out useful features soon.
