...
The updated Find In Files feature- Instant Search shows results as you type. To start a search, press **Ctrl/Cmd + Shift + F** and start entering your query string. You see the matches almost instantly in the results panel as you type in the search bar. You can refine the search in files using case-sensitive and regex searches. You could even make the search in a specific folder or exclude files based on exclusion sets.
