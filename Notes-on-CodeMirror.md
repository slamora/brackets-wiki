The Brackets fork of CodeMirror has a number of fixes and features that we've added in order to support Brackets. We're working to get these into the [main CodeMirror master](http://github.com/marijnh/CodeMirror2). The main features are:
