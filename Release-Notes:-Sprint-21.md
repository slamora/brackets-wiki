...
* During development, JavaScript Code Hinting was made available to the community for evaluation and testing as the brackets-js-code-hints extension. You **must uninstall** this extension before running Sprint 21 to avoid code conflicts.
