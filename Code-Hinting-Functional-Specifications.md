...
* There should be a way to indicate that the hint list has default selection or not. This is required to allow users to insert a tab or new line while the hint list is displayed.
