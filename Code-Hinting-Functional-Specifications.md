 ...
 * [Raymond] The real issue is not on using Tab key to select hint. It is the initial selection in the hint list that will prevent users from inserting a tab or a new line in the editor. See issue #2286 and the solution in pull request #2279.
