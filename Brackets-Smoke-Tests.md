...
5. Disable any 3rd extensions you've installed [extension folder](extension-Folder) (Mac:  `~/Library/Application\ Support/Brackets/extensions/user`, Win: `%appdata%\Brackets\extensions\user`)
