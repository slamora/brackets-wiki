...
* A last minute fix was taken for Sprint 31, so when opening the About dialog, instead of seeing "(On branch master,master ...)", this build will have "(sprint-31-hotfix ...)".
