...
**IMPORTANT:** This setup script only works for 32-bit Linux. 64-bit support is in progress, but not ready yet. Developers have already reported issues with this script on 64-bit Linux. DO NOT ATTEMPT.
